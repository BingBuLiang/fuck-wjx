...
from software.network.proxy.auth import extract_proxy, format_random_ip_error
from software.core.task_context import ProxyLease
...
def _resolve_official_area_request_value(source: str, area_code: Optional[str]) -> str:
    ...
    if not normalized_area:
        return ""
    try:
        from software.core.services.area_service import resolve_proxy_area_for_source
    except Exception:
