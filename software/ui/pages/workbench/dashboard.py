...
from software.ui.pages.workbench.dashboard_parts.clipboard import DashboardClipboardMixin
from software.ui.pages.workbench.dashboard_parts.entries import DashboardEntriesMixin
from software.ui.pages.workbench.dashboard_parts.progress import DashboardProgressMixin
from software.ui.pages.workbench.dashboard_parts.random_ip import DashboardRandomIPMixin
...
from software.io.load_save import RuntimeConfig, build_default_config_filename
...
class DashboardPage(
    ...
    def _on_save_config(self):
        ...
        # 序列化过滤 UI 组件
        from software.io.load_save import serialize_question_entry, deserialize_question_entry
