...
_EXPORTS: Dict[str, Tuple[str, str]] = {
    ...
    "_driver_question_looks_like_rating": ("software.core.engine.dom_helpers", "_driver_question_looks_like_rating"),
    "_driver_question_looks_like_reorder": ("software.core.engine.dom_helpers", "_driver_question_looks_like_reorder"),
    "_count_choice_inputs_driver": ("software.core.engine.dom_helpers", "_count_choice_inputs_driver"),
