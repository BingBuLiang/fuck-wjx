...
from software.ui.pages.workbench.runtime.ai import RuntimeAISection
from software.ui.pages.workbench.runtime.cards import (
    RandomIPSettingCard,
    RandomUASettingCard,
...
class RuntimePage(ScrollArea):
    ...
    def _current_proxy_required_minute(self) -> int:
        try:
            from software.network.proxy import get_proxy_minute_by_answer_seconds
    ...
    def _on_proxy_source_changed(self):
        ...
        try:
            from software.network.proxy.settings import apply_proxy_source_settings
